"""
Django settings for broken_mode_40476 project.
...
ROOT_URLCONF = 'broken_mode_40476.urls'
...
WSGI_APPLICATION = 'broken_mode_40476.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "broken_mode_40476 API",
    "DESCRIPTION": "API documentation for broken_mode_40476 App",
    "VERSION": "v1",
}
